...
///////////////////////////////////////
const Int_t nSiPM_x = 10;            //
const Int_t nSiPM_y = 10;            //
...
const Double_t dx_sipm = 14.05;      // mm
const Double_t dy_sipm = 14.05;      // mm
const Double_t delta_sipm = 0.5;     // mm
const Double_t delta_x0   = -3;      // mm
const Double_t delta_y0   = -3;      // mm
//                                   //
...
Int_t plots_SiPM_array_ASD_NUV() {
